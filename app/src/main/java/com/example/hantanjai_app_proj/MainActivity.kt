...
////        val namesAndValuesRecycle1 = intent.getStringArrayExtra("namesAndValuesRecycle1") ?: emptyArray()
////        val namesAndValuesRecycle2 = intent.getStringArrayExtra("namesAndValuesRecycle2") ?: emptyArray()
////// ใช้ค่าที่ได้รับตามต้องการ
////        val totalTextView = findViewById<TextView>(R.id.maintextotal)
////        totalTextView.text = "Total: $totalValue ฿"
////
////        val recycle1TextView = findViewById<TextView>(R.id.maintextone)
////        recycle1TextView.text = "Recycle 1: ${namesAndValuesRecycle1.joinToString(", ")}"
////
////        val recycle2TextView = findViewById<TextView>(R.id.maintexttwo)
////        recycle2TextView.text = "Recycle 2: ${namesAndValuesRecycle2.joinToString(", ")}"
////
////
////
...
//        val recycle2TextView = findViewById<TextView>(R.id.maintexttwo)
//
//        // Check if namesAndValuesRecycle2 is not empty before displaying
//        if (namesAndValuesRecycle2.isNotEmpty()) {
//            recycle2TextView.text = "Recycle 2: ${namesAndValuesRecycle2.joinToString(", ")}"
//        } else {
//            recycle2TextView.text = "Recycle 2: No data available"
//        }
//
//        // Set up ActionBar
//        supportActionBar?.displayOptions = ActionBar.DISPLAY_SHOW_CUSTOM
...
//        val differences = initialPayments.keys.associateWith { initialPayments[it]!! - actualPayments.getOrDefault(it, 0) }.toMutableMap()
//        println(differences)
...
//
//        // Final differences
//        println("Final differences: $differences")
//
//        // Use the received values as needed
//        val totalTextView = findViewById<TextView>(R.id.maintextotal)
//        totalTextView.text = "Total: $totalValue ฿"
...
//
//
//    private fun calculatePayments(namesAndValues: String?): Map<String, Int> {
//        val payments = mutableMapOf<String, Int>()
//        namesAndValues?.split(", ")?.forEach {
//            val (name, value) = it.split(": ")
//            payments[name] = value.toInt()
//        }
//        return payments
//    }
//
//    // Function to adjust payments
//    private fun adjustPayments(differences: MutableMap<String, Int>): Boolean {
...
//                    val amount = minOf(-differences.getValue(payer), differences.getValue(payee))
//
//                    if (amount > 0) {
//                        println("$payer pays $payee an additional $amount")
//                        val message = "$payer pays $payee an additional $amount"
//                        showToast(message)
//                        differences[payer] = differences.getValue(payer) + amount
//                        differences[payee] = differences.getValue(payee) - amount
//                        changesMade = true
//                    }
//                }
//            }
